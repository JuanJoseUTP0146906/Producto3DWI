    ...
    <body>
        ...
        <div class="carrito">
            <?php if (isset($_SESSION['carrito']) && !empty($_SESSION['carrito'])): ?>
                ...
                <div class="ticket">
                    <div class="ticket-content">
                        <h2><strong>Total: $<?php echo number_format(obtenerTotalCarrito(), 2); ?></strong></h2>
                    </div>
                </div>
                <div class="paypal-buttons">
                    <!-- Botón de PayPal personalizado -->
                    <div id="paypal-container-PZPS7MU9C7DG6"></div>
                    <script>
                    paypal.HostedButtons({
                        hostedButtonId: "PZPS7MU9C7DG6",
                    ...
                    }).render("#paypal-container-PZPS7MU9C7DG6");
                    </script>
                </div>
            <?php else: ?>
